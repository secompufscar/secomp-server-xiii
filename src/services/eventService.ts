...
export default {
    ...
    async create(data: CreateEventDTOS): Promise<EventDTOS> {
        ...
        try {
            ...
            console.error(`[eventService.create] Erro ao tentar atualizar registrationStatus dos usuários para 0:`, error);
    ...
    async delete(eventId: string): Promise<void> {
        try {
            ...
            console.error(`[eventService.delete] Erro crítico ao tentar deletar o evento ${eventId} e suas associações/efeitos colaterais:`, error);
            throw error;
        }
    }
}
