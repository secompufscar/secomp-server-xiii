...
-- AddForeignKey
ALTER TABLE `activityImage` ADD CONSTRAINT `activityImage_activityId_fkey` FOREIGN KEY (`activityId`) REFERENCES `atividades`(`id`) ON DELETE RESTRICT ON UPDATE CASCADE;
